---
title: Pagination
description: 1,000-record server with six pagination patterns — default page, jump, custom size, filter, auto-fetch-all, last page.
---
...
[View on GitHub →](https://github.com/norhther/delta-mcp/tree/main/examples/pagination/)

## See also

- [Result Handler — how it works](/delta-mcp/how-it-works/result-handler/)
- [Result Handler example](/delta-mcp/examples/result-handler/) for truncation and rate-limit patterns
