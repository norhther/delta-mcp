...
description: Real-world Delta-MCP server exposing read/write/list/search file tools with a path sandbox.
---
...
[View on GitHub →](https://github.com/norhther/delta-mcp/tree/main/examples/filesystem-server/)

## Next

See [http-oauth-server](/delta-mcp/examples/http-oauth-server/) to run a similar server over HTTP with OAuth 2.1 protection.
